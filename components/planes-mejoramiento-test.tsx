...
const questionsV1: Question[] = [
  ...
  {
    id: 2,
    question: "Los objetivos del Sistema de Control Interno incluyen:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El MECI adopta el enfoque COSO e incluye 5 componentes: 1) Ambiente de control (integridad, valores, estructura); 2) Evaluación de riesgos (identificación y análisis); 3) Actividades de control (políticas y procedimientos); 4) Información y comunicación (sistemas de información); 5) Actividades de monitoreo y mejora (seguimiento continuo y evaluaciones).",
    topic: "Componentes MECI"
  },
  {
    id: 4,
    question: "La Oficina de Control Interno tiene como función principal:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El mapa de riesgos (Decreto 1083/2015, Guía DAFP) identifica riesgos por proceso y objetivo estratégico, los valora según probabilidad e impacto, los prioriza (zona de riesgo), define controles existentes, calcula riesgo residual, y establece planes de tratamiento (evitar, reducir, compartir, asumir). Se actualiza periódicamente.",
    topic: "Mapa de riesgos"
  },
  {
    id: 6,
    question: "El autocontrol se refiere a:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El Jefe de Control Interno debe elaborar anualmente (Decreto 1083/2015) informe sobre estado del control interno: evalúa funcionamiento del sistema, identifica fortalezas y debilidades, consolida planes de mejoramiento, verifica implementación de acciones correctivas. Se envía a alta dirección, Contraloría, y DAFP. Base para mejora continua.",
  ...
  {
    id: 9,
    question: "La auditoría interna se diferencia de la externa en que:",
    options: [
      "No hay diferencia",
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "La auditoría de gestión y resultados (performance audit) evalúa las '3 E': Economía (adquisición de recursos al menor costo y calidad adecuada), Eficiencia (relación producto/insumo), Eficacia (logro de objetivos y metas). También mide impacto y valor público generado. Va más allá del cumplimiento formal, evalúa desempeño real.",
    topic: "Auditoría de gestión"
  },
  {
    id: 12,
    question: "Los hallazgos de auditoría deben contener:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El programa de auditoría detalla: objetivos específicos por área a auditar, procedimientos y técnicas a aplicar (inspección, observación, confirmación, recálculo, análisis), alcance y limitaciones, cronograma de actividades, recursos necesarios, y responsables. Guía el trabajo del auditor y garantiza cobertura sistemática. Se basa en evaluación de riesgos.",
    topic: "Programa de auditoría"
  },
  {
    id: 14,
    question: "Las normas de auditoría generalmente aceptadas (NAGA) incluyen:",
    options: [
  ...
  {
    id: 16,
    question: "Un Plan de Mejoramiento se elabora como respuesta a:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "Los Planes de Mejoramiento se formulan en respuesta a: hallazgos de auditoría interna, informes de Control Interno, auditorías de Contraloría (CGR), Auditoría General de la República (AGR), Procuraduría, observaciones de supervisión/interventoría, autoevaluación del control interno (MECI), o evaluación de gestión institucional. Es obligatorio y con seguimiento periódico.",
    topic: "Origen de planes de mejoramiento"
  },
  {
    id: 17,
    question: "Las acciones correctivas, preventivas y de mejora se diferencian en que:",
    options: [
      "Son todas iguales",
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "Elementos del Plan de Mejoramiento: 1) Descripción del hallazgo/debilidad; 2) Análisis de causas raíz; 3) Acciones de mejoramiento específicas; 4) Responsable de cada acción; 5) Cronograma de implementación; 6) Recursos necesarios; 7) Indicadores de cumplimiento y eficacia; 8) Estado de avance; 9) Evidencias de implementación. Debe ser SMART (específico, medible, alcanzable, relevante, con tiempo definido).",
    topic: "Contenido del plan de mejoramiento"
  },
  {
    id: 19,
    question: "El seguimiento a Planes de Mejoramiento debe realizarse:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El seguimiento a Planes de Mejoramiento es obligatorio y continuo. Frecuencia: mensual o trimestral según criticidad. Verifica: cumplimiento del cronograma, ejecución efectiva de acciones, evidencias de implementación, resultados obtenidos, eficacia (si corrigió la debilidad), y actualización de estado. Responsables: líder del proceso, Control Interno, y alta dirección. Se reporta a organismos de control.",
    topic: "Seguimiento de planes"
  },
  {
    id: 20,
    question: "El análisis de causa raíz en planes de mejoramiento busca:",
    options: [
  ...
  {
    id: 22,
    question: "El Modelo Integrado de Planeación y Gestión (MIPG) fue adoptado mediante:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El MIPG fue adoptado por el Decreto 1499 de 2017 (ahora compilado en Decreto 1083 de 2015 Sector Función Pública, actualizado). Integra sistemas de gestión de calidad, desarrollo administrativo, control interno (MECI), y gestión ambiental en un modelo único para todas las entidades del Estado. Busca generar resultados que atiendan necesidades y resuelvan problemas de los ciudadanos.",
    topic: "Marco normativo MIPG"
  },
  {
    id: 23,
    question: "Las dimensiones del MIPG son:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El MIPG tiene 7 dimensiones interrelacionadas: 1) Talento Humano; 2) Direccionamiento Estratégico y Planeación; 3) Gestión con Valores para Resultados (incluye 16 políticas de gestión); 4) Evaluación para la Gestión y Resultados; 5) Información y Comunicación; 6) Gestión del Conocimiento e Innovación; 7) Control Interno. Cada dimensión tiene políticas y habilitadores transversales (información, TIC, comunicación).",
    topic: "Dimensiones del MIPG"
  },
  {
    id: 24,
    question: "El FURAG (Formulario Único de Reporte de Avances de Gestión) es:",
    options: [
      "Un trámite opcional",
...
const questionsV2: Question[] = [
  ...
  {
    id: 26,
    question: "El modelo COSO (Committee of Sponsoring Organizations) enfatiza:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "COSO es el marco de referencia internacional de control interno más aceptado. COSO I (1992, actualizado 2013) define control interno con 5 componentes integrados. COSO ERM (2004, actualizado 2017) amplía a gestión de riesgos empresariales. Colombia adoptó COSO como base del MECI. Enfatiza la interrelación de componentes y que el control es responsabilidad de todos.",
    topic: "Modelo COSO"
  },
  {
    id: 27,
    question: "La segregación de funciones como actividad de control busca:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "Controles preventivos: evitan que ocurra el error o fraude (ej: segregación de funciones, autorizaciones, capacitación). Controles detectivos: identifican errores o fraudes ya ocurridos (ej: conciliaciones, revisiones, auditorías). Controles correctivos: corrigen y recuperan de errores detectados (ej: reversiones, ajustes, planes de mejora). El sistema debe combinar los tres tipos balanceadamente.",
    topic: "Tipos de controles"
  },
  {
    id: 29,
    question: "El Comité de Coordinación de Control Interno tiene como función:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "Riesgo de auditoría = Riesgo Inherente × Riesgo de Control × Riesgo de Detección. Riesgo Inherente: susceptibilidad de un área a errores significativos sin considerar controles. Riesgo de Control: que los controles no prevengan/detecten errores materiales. Riesgo de Detección: que los procedimientos del auditor no detecten errores existentes. El auditor evalúa los dos primeros para diseñar el tercero (naturaleza y alcance de pruebas).",
  ...
  {
    id: 32,
    question: "La evidencia de auditoría debe ser:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El muestreo estadístico usa teoría de probabilidades para: determinar tamaño de muestra (basado en nivel de confianza 90-95%, error tolerable, error esperado), seleccionar muestra aleatoria (aleatoria simple, sistemática, estratificada), evaluar resultados, y proyectar hallazgos a la población con precisión cuantificable. Ventajas: objetividad, menor tamaño de muestra que juicio, cuantificación de riesgo. Requiere población homogénea.",
    topic: "Muestreo estadístico"
  },
  {
    id: 34,
    question: "La auditoría forense se enfoca en:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "La auditoría forense combina técnicas de auditoría, contabilidad e investigación para detectar y documentar fraudes, corrupción, lavado de activos, malversación. Características: recopilación de evidencia con cadena de custodia, análisis financiero forense, entrevistas especializadas, informes periciales con validez judicial. Apoya procesos penales, fiscales, disciplinarios. Requiere especialización y conocimiento de procedimiento penal.",
    topic: "Auditoría forense"
  },
  {
    id: 35,
    question: "La auditoría de sistemas de información evalúa:",
    options: [
  ...
  {
    id: 38,
    question: "El ciclo PHVA (Planear-Hacer-Verificar-Actuar) aplicado a planes de mejoramiento implica:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "El ciclo PHVA (Deming) de mejora continua: Planear (identificar problema, analizar causas, planificar acciones), Hacer (implementar acciones piloto o definitivas), Verificar (medir resultados, comparar con objetivo, evaluar eficacia), Actuar (si funciona: estandarizar y documentar; si no: ajustar y repetir ciclo). Garantiza mejora sistemática y sostenible. Base de sistemas de calidad ISO 9001 y MIPG.",
    topic: "Ciclo PHVA"
  },
  {
    id: 39,
    question: "Los indicadores en planes de mejoramiento deben ser:",
    options: [
      "Genéricos y vagos",
  ...
  {
    id: 45,
    question: "El Sistema de Gestión de la Calidad (SGC) bajo norma ISO 9001 enfatiza:",
    options: [
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "ISO 9001:2015 se basa en 7 principios de gestión de calidad: 1) Enfoque al cliente (satisfacer necesidades); 2) Liderazgo (dirección unificada); 3) Compromiso de las personas; 4) Enfoque basado en procesos; 5) Mejora continua; 6) Toma de decisiones basada en evidencia; 7) Gestión de las relaciones. Requiere: identificar procesos, establecer indicadores, implementar PHVA, auditorías internas, revisión por la dirección, y mejora continua.",
    topic: "ISO 9001 y SGC"
  },
  {
    id: 46,
    question: "La caracterización de procesos debe incluir:",
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    points: 5,
    explanation: "Benchmarking es aprendizaje de mejores prácticas: 1) Identificar proceso a mejorar; 2) Seleccionar entidades referentes (líderes en ese proceso); 3) Recopilar información (visitas, encuestas, bases de datos); 4) Comparar desempeño (brechas en indicadores); 5) Identificar mejores prácticas; 6) Adaptar e implementar en la propia entidad; 7) Monitorear mejora. Acelera mejora al no 'reinventar la rueda'. Común en MIPG.",
    topic: "Benchmarking"
  },
  {
    id: 50,
