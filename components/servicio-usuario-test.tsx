...
const questionsV1: Question[] = [
  ...
  {
    id: 2,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La presentación enfatiza que la atención al ciudadano es fundamental porque:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, se destaca que la atención al ciudadano sostiene el Estado Social de Derecho, habilita el control social y promueve transparencia, empatía y eficiencia.",
    topic: "Importancia de la atención al ciudadano"
  },
  {
    id: 3,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. ¿Cuál de los siguientes ítems hace parte del contenido abordado en la presentación?",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los temas incluyen desarrollo normativo, deberes, derechos, ciclo del servicio, roles, canales, protocolos, atención a poblaciones vulnerables, manejo de situaciones difíciles, NTC 6047 y Carta de Trato Digno.",
    topic: "Contenido de la capacitación"
  },
  {
    id: 4,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. De acuerdo con los deberes institucionales, las entidades deben:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la presentación señala que las entidades deben disponer de oficina de atención, mínimo 40 horas semanales, turnos, trato prioritario y medios tecnológicos, además de gestionar PQRS.",
    topic: "Deberes de las entidades"
  },
  {
    id: 5,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Entre los derechos de los ciudadanos se encuentra:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los derechos incluyen atención digna y respetuosa, información clara, uso de canales oficiales, atención preferencial en casos especiales y la posibilidad de presentar PQRSDF.",
    topic: "Derechos de los ciudadanos"
  },
  {
    id: 6,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. El ciclo del servicio descrito en la presentación incluye las fases:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, el ciclo del servicio se compone de cinco momentos: identificación de la necesidad, contacto, atención, respuesta y percepción final.",
    topic: "Ciclo del servicio"
  },
  {
    id: 7,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Los canales de atención mencionados en la presentación son:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los canales incluyen atención presencial, telefónica, virtual, correo electrónico y redes sociales, cada uno con protocolos específicos.",
    topic: "Canales de atención"
  },
  {
    id: 8,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Respecto a la atención a poblaciones vulnerables, la presentación enfatiza que:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, atención a poblaciones vulnerables demanda protocolos específicos que garanticen trato prioritario, accesibilidad y acompañamiento.",
    topic: "Atención a poblaciones vulnerables"
  },
  {
    id: 9,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La NTC 6047, según la presentación, se relaciona con:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la NTC 6047 fija estándares de calidad, accesibilidad, comunicación y seguimiento para la atención al ciudadano.",
    topic: "Norma Técnica Colombiana 6047"
  },
  {
    id: 10,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La Carta de Trato Digno, de acuerdo con la presentación, es:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la Carta de Trato Digno formaliza los compromisos de la entidad con los ciudadanos respecto al trato y la calidad del servicio.",
    topic: "Carta de Trato Digno"
  },
  {
    id: 11,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Sobre los protocolos de atención, la presentación resalta que:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los protocolos son guías que estandarizan la atención para garantizar coherencia y calidad en todos los canales.",
    topic: "Protocolos de atención"
  },
  {
    id: 12,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. El documento enfatiza que la presentación no contiene:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, se aclara que la presentación es material informativo para capacitación y no incluye preguntas de examen o cuestionarios.",
    topic: "Naturaleza del material"
  },
  {
    id: 13,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. El control social que promueve la atención al ciudadano se traduce en:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la atención al ciudadano fomenta el control social, fortaleciendo la confianza institucional y la transparencia.",
    topic: "Importancia de la atención al ciudadano"
  },
  {
    id: 14,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Según los deberes institucionales, la gestión de PQRSDF debe:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los deberes incluyen gestionar oportunamente las PQRSDF para asegurar satisfacción y seguimiento.",
    topic: "Gestión de PQRSDF"
  },
  {
    id: 15,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. El manejo de situaciones difíciles requiere:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la presentación resalta que es fundamental disponer de protocolos y habilidades para gestionar situaciones difíciles con respeto y empatía.",
    topic: "Manejo de situaciones difíciles"
  },
  {
    id: 16,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Cuando se menciona que los roles del servicio aparecen como “xxxx”, se sugiere que:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la notación “xxxx” indica que la sección de roles requiere complementar información, aunque forma parte del contenido base de la capacitación.",
    topic: "Roles del servicio"
  },
  {
    id: 17,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La presentación resalta que los principios de atención al ciudadano aplican:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, se señala que la gestión orientada al ciudadano trasciende el sector público y aplica también a entidades privadas.",
    topic: "Alcance institucional"
  },
  {
    id: 18,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Una consecuencia de no actualizar la Carta de Trato Digno sería:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la Carta de Trato Digno debe mantenerse actualizada para reflejar compromisos de servicio; no hacerlo deteriora la confianza y claridad hacia el ciudadano.",
    topic: "Carta de Trato Digno"
  },
  {
    id: 19,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. En términos de accesibilidad, la NTC 6047 orienta a que los servicios:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la NTC 6047 establece estándares de accesibilidad, lo que implica adaptar canales y recursos para poblaciones con necesidades especiales.",
...
const questionsV2: Question[] = [
  ...
  {
    id: 2,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Si una entidad brinda atención al ciudadano con menos de 40 horas semanales, estaría incumpliendo porque:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los deberes institucionales descritos incluyen contar con un horario mínimo de 40 horas semanales.",
    topic: "Deberes de las entidades"
  },
  {
    id: 3,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Al diseñar un protocolo para atención telefónica coherente con la presentación, se debe garantizar:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los protocolos deben cubrir cada canal con personal capacitado, trato respetuoso y mecanismos de seguimiento.",
    topic: "Protocolos por canal"
  },
  {
    id: 4,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Una situación difícil con un ciudadano inconforme debe manejarse:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, el manejo de situaciones difíciles exige protocolos y habilidades de escucha, empatía y respeto.",
    topic: "Manejo de situaciones difíciles"
  },
  {
    id: 5,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. En la fase de contacto del ciclo del servicio se hace énfasis en:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, tras identificar la necesidad, el contacto es la primera interacción con el ciudadano en el canal escogido.",
    topic: "Ciclo del servicio"
  },
  {
    id: 6,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La fase de percepción final del usuario busca:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la percepción final permite conocer la valoración del servicio y orientar la mejora continua.",
    topic: "Ciclo del servicio"
  },
  {
    id: 7,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Si una entidad no actualiza la Carta de Trato Digno, podría afectarse porque:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la Carta de Trato Digno debe mantenerse vigente para reflejar compromisos actuales; no actualizarla afecta la confianza y claridad hacia la ciudadanía.",
    topic: "Carta de Trato Digno"
  },
  {
    id: 8,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. En la atención a poblaciones vulnerables, la entidad debe:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la presentación resalta adaptar protocolos para garantizar accesibilidad, prioridad y acompañamiento a poblaciones vulnerables.",
    topic: "Atención a poblaciones vulnerables"
  },
  {
    id: 9,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Una guía práctica de NTC 6047 sugiere:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la NTC 6047 se enfoca en estándares de accesibilidad, comunicación clara, seguimiento y satisfacción del ciudadano.",
    topic: "Norma Técnica Colombiana 6047"
  },
  {
    id: 10,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Si al revisar los roles del servicio la entidad encuentra la anotación “xxxx”, debe:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la notación sugiere completar la información de roles para establecer responsabilidades claras y coherencia en la atención.",
    topic: "Roles del servicio"
  },
  {
    id: 11,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La gestión de canales como redes sociales requiere:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, cada canal debe contar con personal capacitado, protocolos y seguimiento para mantener la calidad del servicio.",
    topic: "Canales de atención"
  },
  {
    id: 12,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Si un ciudadano plantea una solicitud a través de correo electrónico, la entidad debe:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los deberes institucionales comprenden atender solicitudes por los canales habilitados, con respuestas oportunas y seguimiento.",
    topic: "Gestión de PQRSDF"
  },
  {
    id: 13,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La presentación resalta que la atención al ciudadano también aplica a entidades privadas porque:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, se enfatiza que los principios de servicio orientado al ciudadano son aplicables también en entidades privadas.",
    topic: "Alcance institucional"
  },
  {
    id: 14,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Para fortalecer la transparencia, la entidad debe:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la importancia de la atención al ciudadano se asocia con facilitar control social, generar confianza y promover transparencia y empatía.",
    topic: "Importancia de la atención al ciudadano"
  },
  {
    id: 15,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. El sistema de turnos y trato prioritario tiene como fin:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, el sistema de turnos y trato prioritario busca asegurar orden y priorizar a quienes requieren atención especial.",
    topic: "Deberes de las entidades"
  },
  {
    id: 16,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. La percepción final del usuario debe registrarse para:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, conocer la percepción final alimenta la mejora continua y permite medir satisfacción y calidad del servicio.",
    topic: "Ciclo del servicio"
  },
  {
    id: 17,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Una entidad que no ofrezca medios tecnológicos para la atención estaría incumpliendo porque:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, los deberes de las entidades incluyen habilitar medios tecnológicos para gestionar las solicitudes ciudadanas.",
    topic: "Deberes de las entidades"
  },
  {
    id: 18,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Si un funcionario desconoce los derechos de los ciudadanos en la prestación del servicio, la capacitación sugiere:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la capacitación busca sensibilizar sobre derechos fundamentales de los ciudadanos durante la atención.",
    topic: "Derechos de los ciudadanos"
  },
  {
    id: 19,
    question: "Lectura: En el Centro Integrado de Atención se reciben altos volúmenes de PQRS y se busca fortalecer la experiencia del ciudadano. Un ejemplo de seguimiento coherente con la NTC 6047 sería:",
    options: [
    ...
    points: 4,
    explanation:
      "En la situación descrita, la NTC 6047 sugiere seguimiento y satisfacción para garantizar calidad y accesibilidad.",
    topic: "Norma Técnica Colombiana 6047"
  },
  {
    id: 20,
